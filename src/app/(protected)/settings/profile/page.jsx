...
import { getProfile } from "@/lib/api/profile.api.js";
  ...
  if (name === "building") {
    return (
      <svg {...common}>
        ...
        />{" "}
        <path strokeWidth="1.8" strokeLinecap="round" d="M16 9h4v12" />{" "}
        <path
          strokeWidth="1.8"
          strokeLinecap="round"
          d="M8 7h4M8 11h4M8 15h4"
        />{" "}
        <path strokeWidth="1.8" strokeLinecap="round" d="M2 21h20" />{" "}
      </svg>
    );
  }
...
export default function ProfileSettingsPage() {
  ...
  const handleProfileUpdated = async (updatedUser) => {
    ...
    try {
      ...
      console.error("Unable to refresh authenticated user:", refreshError);
    }
  };
  ...
  const organization = profile?.organizationId?.name || "Global / System";
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-gray-500">
                  Update your first name, last name and contact information.
                </p>
              </div>
            </div>
          </div>
